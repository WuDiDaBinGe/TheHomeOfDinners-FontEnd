<template>
	...
	<main>
		<Restaurant_reviews_summary></Restaurant_reviews_summary>
		...
		<div class="container margin_60_35">
          ...
          <form autocomplete="off" action="/reviewdetail" method="post" id="redetail">
				...
				<!-- /col -->
        <Restaurant_Info_Card></Restaurant_Info_Card>
